...
* [ogkalu2/comic-translate](https://github.com/ogkalu2/comic-translate): AI manga translator and comic translator app for automatically translating manga, comics, manhwa, BDs, fumetti, and more in multiple languages and formats (images, PDF, EPUB, CBR, CBZ).
...
* [vibheksoni/free-ai](https://github.com/vibheksoni/free-ai): Free OpenAI-compatible AI API for builders. Join Discord, run /signup, get a key, and use free models.
...
* [hatesthaha/zhongchou](https://github.com/hatesthaha/zhongchou): 基于yii2的微信众筹项目，已上线
