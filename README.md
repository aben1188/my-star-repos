...
* [LYiHub/Cyber-Zen-Master](https://github.com/LYiHub/Cyber-Zen-Master): 一个基于DeepSeek的哲理问答思维链多步推理工作流
...
* [NezhaFan/sieve](https://github.com/NezhaFan/sieve): 关键词/敏感词检测，支持通配符和标签分类 。( AC自动机、trie树 、DFA算法 )
