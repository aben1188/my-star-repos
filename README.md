...
* [shinpr/sub-agents-skills](https://github.com/shinpr/sub-agents-skills): Cross-LLM sub-agent orchestration as an Agent Skills. Route tasks to Codex, Claude Code, Grok, GLM, Cursor, Gemini, or OpenCode from any compatible tool.
