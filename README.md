...
* [AnyVM-Tech/AnyGPT](https://github.com/AnyVM-Tech/AnyGPT): a simple, intuitive api and webui to get any ai model from for free or to selfhost. incorporates other api technologies into your request such as wolfram, web search, image or voice to text, and more! (also provides a load balancer for the providers side to maximize speed across users, the api is compatible with all other webuis)
...
* [cssmagic/CSS-Secrets](https://github.com/cssmagic/CSS-Secrets): 📖 Chinese edition of *CSS Secrets* |《CSS 揭秘》这本书的大本营
...
* [yuvenhol/dataharvest](https://github.com/yuvenhol/dataharvest): DataHarvest is a tool for data search 🔍, crawling 🕷, and cleaning 🧽.
...
* [easychen/fxd](https://github.com/easychen/fxd): Flow eXtension Define，它是一个被设计用于工作流（尤其是AI和自动化工作流）扩展的规范。"Flow eXtension Define" is a specification designed for extending workflows, especially AI and automation workflows.
...
* [yamadashy/github-deepwiki-button](https://github.com/yamadashy/github-deepwiki-button): Add a [DeepWiki] button to quickly access DeepWiki from GitHub repositories
...
* [ridzenis/gvimfullscreen_win32](https://github.com/ridzenis/gvimfullscreen_win32): Plugin to allow full screen use in gvim on Windows
...
* [lilinji-TT/idea-to-card](https://github.com/lilinji-TT/idea-to-card): 输入文字让AI生成卡片
...
* [xinghalo/JQuery-Steps](https://github.com/xinghalo/JQuery-Steps): 自己使用的Ystep，fork自【ystep】
...
* [coolhwm/leshare-seller-wepy](https://github.com/coolhwm/leshare-seller-wepy): 基于小程序的店铺商家管理端，采用wepy框架开发
...
* [win4r/LingoLearn-iOS](https://github.com/win4r/LingoLearn-iOS): None
...
* [OminousIndustries/PhoneDriver](https://github.com/OminousIndustries/PhoneDriver): Android Phone Control With Qwen3-VL
...
* [ares333/php-curl](https://github.com/ares333/php-curl): php curl concurrent library
...
* [NicklasWallgren/php-lrucache](https://github.com/NicklasWallgren/php-lrucache): LRU Cache implementation in PHP
* [rogeriopvl/php-lrucache](https://github.com/rogeriopvl/php-lrucache): LRU Cache implementation in PHP
...
* [jurosh/php-pdf-merge](https://github.com/jurosh/php-pdf-merge): PDF Merge library for PHP
* [lincanbin/PHP-PDO-MySQL-Class](https://github.com/lincanbin/PHP-PDO-MySQL-Class): A PHP MySQL PDO class similar to the the Python MySQLdb,  which supports iterator and parameter binding when using "WHERE IN" statement.
...
* [ProfSynapse/Professor-Synapse](https://github.com/ProfSynapse/Professor-Synapse): None
...
* [shinpr/sub-agents-skills](https://github.com/shinpr/sub-agents-skills): Cross-LLM sub-agent orchestration as an Agent Skills. Route tasks to Codex, Claude Code, Grok, GLM, Kimi, Cursor, Gemini, or OpenCode from any compatible tool.
...
* [zjh129/swooleWechat](https://github.com/zjh129/swooleWechat): 使用swoole framework搭建一个微信服务号接口开发项目，其中使用了EasyWeChat微信开源项目
...
* [XiaomingX/twitter-video-download](https://github.com/XiaomingX/twitter-video-download): 下载推特上的视频的工具（as the name , twitter video download）
...
* [nelstrom/vim-cutlass](https://github.com/nelstrom/vim-cutlass): Taking Vim's copy/paste system beyond 'good enough'
...
* [ArthurChiao/vim_awesome](https://github.com/ArthurChiao/vim_awesome): my vim configuration, based on amix's project (https://github.com/amix/vimrc).
* [hzheng/vimconf](https://github.com/hzheng/vimconf): vim configurations
...
* [Jia-Joe/vrapperrc_vsvimrc](https://github.com/Jia-Joe/vrapperrc_vsvimrc): Configuration Files : Eclipse + Vrapper ,Visual Stidio+VsVim
...
* [zhihuifanqiechaodan/vue3-admin-template](https://github.com/zhihuifanqiechaodan/vue3-admin-template): About 🎉 A magical vue3 admin
...
* [CFETeam/weapp-demo-session](https://github.com/CFETeam/weapp-demo-session): The weapp-session demo of wechat micro program
* [jsongo/weApp-frame](https://github.com/jsongo/weApp-frame): 微信小程序，界面主框架
...
* [ChisBread/wechat-service](https://github.com/ChisBread/wechat-service): 🤖Let your WeChat run as a service
* [byg/wechat-textinput](https://github.com/byg/wechat-textinput): 微信小程序 textinput 的 wepy 版本和 mpvue 版本性能对比
* [jectychen/wechat-v2ex](https://github.com/jectychen/wechat-v2ex): 微信小程序-v2ex
* [lypeer/wechat-weapp-gank](https://github.com/lypeer/wechat-weapp-gank): None
* [yll2wcf/wechat-weapp-lifeTools](https://github.com/yll2wcf/wechat-weapp-lifeTools): 微信小程序生活工具集合
...
* [kkx600/WechatBot](https://github.com/kkx600/WechatBot): 一个基于PC版的微信机器人，采用hook的形式进行消息拦截，内存信息读取的形式，实现安全工具，安全资讯，安全客，freebuf等安全论坛自动推送以及每日早报，晚报和娱乐功能，并且还加入当前最火的openai对话功能
...
* [weifund/weifund](https://github.com/weifund/weifund): A decentralized, fully transparent, open-source crowdfunding platform built on Ethereum.
* [GzThLee/weixiaoqing](https://github.com/GzThLee/weixiaoqing): 微小擎，PHP免费开源的微信管理系统，便于开发者二次开发。系统实现了微信公众号、企业微信的基础功能如：菜单设置，粉丝管理，关键字回复，客户管理，客户群管理等；同时提供高级功能如：渠道二维码，模板消息推送等。
...
* [we-plugin/wepy-com-swiper](https://github.com/we-plugin/wepy-com-swiper): :sparkles: 微信小程序触摸内容滑动解决方案，适用于wepy框架
* [ochukai/wepy-com-toptip](https://github.com/ochukai/wepy-com-toptip): a toptip component for 小程序~
* [Thunf/wepy-demo-bookmall](https://github.com/Thunf/wepy-demo-bookmall): Demo codes for 🐼📖 which used in a very early version.
* [billyma128/wepy-img-loader](https://github.com/billyma128/wepy-img-loader): A fork of wxapp-img-loader(https://github.com/o2team/wxapp-img-loader)
* [brucx/wepy-ionic-components](https://github.com/brucx/wepy-ionic-components): 将 ionic 组件迁移到微信小程序 Wepy 框架下
* [dyq086/wepy-mall](https://github.com/dyq086/wepy-mall): 微信小程序--基于wepy 商城(微店)微信小程序 欢迎学习交流
* [huangang/wepy-nideshop](https://github.com/huangang/wepy-nideshop): None
* [huangang/wepy-one](https://github.com/huangang/wepy-one): 小程序-one(wepy版本)
* [li-xianfeng/wepy-plugin-autoprefixer](https://github.com/li-xianfeng/wepy-plugin-autoprefixer): wepy框架autoprefixer插件
* [hjkcai/wepy-plugin-axios](https://github.com/hjkcai/wepy-plugin-axios): 在 wepy 中使用 axios
* [xwxtwd/wepy-plugin-img2base64](https://github.com/xwxtwd/wepy-plugin-img2base64): 小程序组件化开发框架 WePy 插件
* [0851/wepy-plugin-usingcomponents](https://github.com/0851/wepy-plugin-usingcomponents): wepy-plugin-usingcomponents auto require wx min app usingcomponents
* [GeoffZhu/wepy-swipe-delete](https://github.com/GeoffZhu/wepy-swipe-delete): 微信小程序框架wepy - 滑动删除插件
* [brucx/wepy-zanui-demo](https://github.com/brucx/wepy-zanui-demo): 基于zanui-weapp移植的一套wepy界面框架
...
* [baymaxLimited/wx-server-sdk-ts](https://github.com/baymaxLimited/wx-server-sdk-ts): None
* [webdzq/wx-wpy-demo](https://github.com/webdzq/wx-wpy-demo): 用wepy,vuejs,es6等来开发微信小程序
* [hss01248/wxapp-devFrame](https://github.com/hss01248/wxapp-devFrame): 小程序基本的开发框架抽取
...
* [sands321/zagi](https://github.com/sands321/zagi): Release the power of GPT
