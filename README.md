...
* [akl7777777/bob-plugin-akl-deepl-free-translate](https://github.com/akl7777777/bob-plugin-akl-deepl-free-translate): 免费无限次使用deepl,根据网页版JavaScript加密算法开发的bobplugin;所以只要官网的算法不改,理论上就可以无限使用;
...
* [0xYootou/eth-self-token-example](https://github.com/0xYootou/eth-self-token-example): 在本地网络发布一个名叫 YuTou 的 token
...
* [leidenglai/opencv-js-qrcode](https://github.com/leidenglai/opencv-js-qrcode): 基于opencv与wechat_qrcode编译的纯前端二维码识别demo
...
* [streetlight3316/toolbox](https://github.com/streetlight3316/toolbox): None
...
* [lixh00/web-wechat](https://github.com/lixh00/web-wechat): 基于`Golang`语言和`Gin`框架的个人微信系统
